...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2022 at 03:57 PM
...
('EM/02', 'Josephine', 'Darakjy', '810-292-9388', 33000),
...
('PID2011', '2019/E/032', 1200, '2019-03-24', 'VisaCard'),
('PID2012', '2019/E/039', 1200, '2019-07-25', 'Cash'),
('PID2013', '2019/E/049', 1200, '2019-03-29', 'Cash'),
('PID2014', '2019/E/061', 1200, '2019-09-27', 'VisaCard'),
('PID2015', '2019/E/132', 1200, '2019-07-11', 'Online'),
...
('PID2022', '2019/E/132', 1200, '2019-07-25', 'Cash'),
('PID2023', '2019/E/039', 1200, '2019-03-27', 'Online'),
('PID2024', '2019/E/025', 1200, '2022-10-20', 'Visa'),
('PID2025', '2019/E/025', 1200, '2022-10-21', 'Visa'),
('PID2026', '2019/E/025', 1200, '2022-10-21', 'Online'),
('PID2027', '2019/E/040', 1200, '1970-01-01', 'Online'),
('PID2028', '2019/E/039', 1200, '2022-10-21', 'Visa'),
('PID2029', '2019/E/032', 1200, '2022-10-21', 'Online');
...
CREATE TABLE `student` (
  ...
  `HostelID` varchar(6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `student` (`StudentID`, `RoomID`, `Fname`, `Lname`, `Age`, `MobileNo`, `Department`, `Status`, `Address`, `HostelID`) VALUES
('2019/E/024', 'FF-02', 'Diluxan', 'Rasen', 24, '0123456789', 'Computer', 'Yes', 'Killinochi', 'H001'),
('2019/E/025', 'FF-06', 'Dansten', 'Croos', 24, '076-8517674', 'Civil', 'yes', '6 S 33rd St,Mannar', 'H001'),
('2019/E/032', 'FF-07', 'Dilushan', 'Guna', 22, '076-8517675', 'Computer', 'yes', '6 Greenleaf Ave,Trinco', 'H001'),
('2019/E/034', 'FF-09', 'Tharu', 'Yogan', 23, '0987564321', 'Mechanical', 'Yes', 'Vavuniya', 'H003'),
('2019/E/039', 'FF-08', 'Gowsikan', 'Nakuleswaran', 23, '076-8517676', 'Computer', 'yes', '618 W Yakima Ave,Vavuniya', 'H001'),
('2019/E/040', 'FF-08', 'Haleeth', 'Mohammed', 23, '9512634780', 'Civil', 'Yes', 'Horapoththana', 'H001'),
('2019/E/049', 'FF-11', 'Jathurshan', 'Sownthar', 24, '076-8517677', 'Computer', 'yes', '74 S Westgate St,Trinco', 'H001'),
('2019/E/061', 'FF-13', 'Keshikan', 'Baskaran', 23, '076-8517678', 'Civil', 'no', '3273 State St,Mullai', 'H001'),
('2019/E/065', 'FF-14', 'Lalith', 'Kumar', 25, '076-8517679', 'EEE', 'yes', '1 Central Ave,Nuwa', 'H001'),
('2019/E/112', 'FF-23', 'Rishikee', 'Hariharan', 23, '076-8517680', 'Civil', 'yes', '86 Nw 66th St #8673,Trinco', 'H001'),
('2019/E/128', 'FF-26', 'Saarankan', 'Santhiran', 23, '076-8517681', 'Civil', 'yes', '2 Cedar Ave #84,Kilinochi', 'H001'),
('2019/E/132', 'FF-26', 'Senthooran', 'Suthar', 23, '076-8517682', 'Computer', 'no', '90991 Thorburn Ave,Vavuniya', 'H001'),
('2019/E/134', 'FF-26', 'Siranchith', 'Kirakalan', 23, '076-8517683', 'Civil', 'yes', '386 9th Ave N,Mullai', 'H001'),
('2019/E/150', 'SF-03', 'Thushan', 'Subas', 23, '076-8517684', 'EEE', 'yes', '74874 Atlantic Ave,Vavuniya', 'H002'),
('2019/E/158', 'SF-05', 'Vithusan', 'Kennedy', 23, '076-8517685', 'EEE', 'yes', '366 South Dr,Kilinochi', 'H002'),
('2019/E/159', 'SF-05', 'Vithusan', 'Ampi', 23, '076-8517686', 'Civil', 'yes', '45 E Liberty St,Kilinochi', 'H002'),
('2019/E/175', 'SF-07', 'Yesinthan', 'Rathakrish', 23, '076-8517687', 'EEE', 'yes', '4 Ralph Ct,Nuwa', 'H002');
...
(4, 930544231296, 'qwerty', 'qwerty', '2022-10-20 16:25:53'),
...
('V01', '2019/E/039', '14:22:21', '16:57:46', '2019-10-09', 'F'),
...
('V07', '2019/E/132', '12:05:12', '14:09:58', '2019-09-26', 'F'),
...
('V11', '2019/E/025', '16:43:00', '00:00:00', '2022-10-20', 'F'),
...
ALTER TABLE `student`
  ...
  ADD KEY `student_ibfk_2` (`HostelID`);
...
--
ALTER TABLE `room`
  ADD CONSTRAINT `room_ibfk_1` FOREIGN KEY (`HostelID`) REFERENCES `hostel` (`HostelID`) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE `student`
  ...
  ADD CONSTRAINT `student_ibfk_2` FOREIGN KEY (`HostelID`) REFERENCES `hostel` (`HostelID`) ON DELETE SET NULL ON UPDATE CASCADE;
